...
## Этап 2: Настройка TaskListViewModel
...
## Этап 3: Верстка TaskListScreen (Список задач)
...
## Этап 4: Настройка TaskDetailViewModel
...
## Этап 5: Верстка TaskDetailScreen (Форма создания/редактирования)
