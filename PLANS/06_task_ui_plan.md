...
## [ОЖИДАЕТ] Этап 2: Настройка TaskListViewModel
...
## [ОЖИДАЕТ] Этап 3: Верстка TaskListScreen (Список задач)
...
## [ОЖИДАЕТ] Этап 4: Настройка TaskDetailViewModel
...
## [ОЖИДАЕТ] Этап 5: Верстка TaskDetailScreen (Форма создания/редактирования)
