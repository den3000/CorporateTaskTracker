...
## Этап 1: Создание компонента PriorityBadge
...
## Этап 2: Обновление верстки в TaskDetailScreen
...
## Этап 3: Подготовка состояния для ModalBottomSheet
...
## Этап 4: Реализация ModalBottomSheet
...
## Этап 5: Локализация и полировка (Опционально)
