...
## Этап 1: Реорганизация Моделей (Shared)
...
## Этап 2: Подключение Room в composeApp
...
## Этап 3: Создание Сущностей и DAO (composeApp)
...
## Этап 4: База данных и Платформенная реализация
...
## Этап 5: Репозиторий и Интеграция с UI
