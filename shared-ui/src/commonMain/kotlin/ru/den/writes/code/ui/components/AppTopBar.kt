...
import ru.den.writes.code.resources.app_name
import ru.den.writes.code.resources.arrow_back_24px
import ru.den.writes.code.resources.content_desc_back
import ru.den.writes.code.resources.content_desc_settings
import ru.den.writes.code.resources.settings_24px
import ru.den.writes.code.resources.title_settings
import ru.den.writes.code.resources.title_task_detail
import ru.den.writes.code.resources.title_tasks
